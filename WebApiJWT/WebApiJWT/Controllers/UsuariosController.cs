...
namespace WebApiJWT.Controllers
{
    public class UsuariosController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetUsuario(short id)
        {
        ...
        public async Task<IHttpActionResult> PutUsuario(short id, Usuario usuario)
        {
        ...
        [ResponseType(typeof(Usuario))]
        public async Task<IHttpActionResult> DeleteUsuario(short id)
        {
            Usuario usuario = await db.Usuario.FindAsync(id);
            if (usuario == null)
            {
